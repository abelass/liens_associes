...
function liens_associes_upgrade($nom_meta_base_version, $version_cible) {
	...
	$maj['create'] = array(array('maj_tables', array('spip_related_links', 'spip_related_links_liens')));
...
function liens_associes_vider_tables($nom_meta_base_version) {
	...
	sql_drop_table('spip_related_links');
	sql_drop_table('spip_related_links_liens');

	# Nettoyer les liens courants (le génie optimiser_base_disparus se chargera de nettoyer toutes les tables de liens)
	sql_delete('spip_documents_liens', sql_in('objet', array('related_link')));
	sql_delete('spip_mots_liens', sql_in('objet', array('related_link')));
	sql_delete('spip_auteurs_liens', sql_in('objet', array('related_link')));
	# Nettoyer les versionnages et forums
	sql_delete('spip_versions', sql_in('objet', array('related_link')));
	sql_delete('spip_versions_fragments', sql_in('objet', array('related_link')));
	sql_delete('spip_forum', sql_in('objet', array('related_link')));
